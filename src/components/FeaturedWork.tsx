...
const featuredWork = [
	...
	{
		src: 'https://lh3.googleusercontent.com/pw/AP1GczNEOEhO4jD34iadIimZsyKzOTTpd1vQY_h361Cq80C8nWyARDfXwuT5wLdbqapU63pNBIGdLd32YiIDwWldaCSl9hA3nj7tk3xUPEXtc37AtUpPCgAQ0GehpfO8lXWX-v0a3zNBq0zPAsQzpGeowsrTDg=w521-h698-s-no-gm',
		alt: 'Custom tooled leather wallet from the wallets album',
		title: 'Wallet Set',
		category: 'Wallets',
		span: '',
		width: 521,
