		...
		<section className="px-4 sm:px-6 lg:px-8 py-20">
			<div className="max-w-5xl mx-auto">
				...
				<p className="text-beige text-center mb-12 text-lg">
					Don&apos;t just take our word for it. See what customers have to say about
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
					...
					>
						...
						<p className="text-beige">Read authentic reviews from satisfied customers on Google.</p>
					</a>
					...
					>
						...
						<p className="text-beige">Connect with us and see reviews from our Facebook community.</p>
					</a>
				</div>
			</div>
		</section>
