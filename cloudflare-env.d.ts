/* eslint-disable */
// Generated by Wrangler (configuration hash: 314a23b376b8bb7c0a3b247924c6d3d2)
// Runtime types generated with workerd@1.20260630.1 2025-12-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ORDER_ASSETS: R2Bucket;
	DB: D1Database;
	ORDER_INTENT_RATE_LIMITER: RateLimit;
	ORDER_UPLOAD_RATE_LIMITER: RateLimit;
	ORDER_CHECKOUT_RATE_LIMITER: RateLimit;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SQUARE_ENVIRONMENT: "production";
	SQUARE_PRODUCTION_LOCATION_ID: "KMGV4Y657Z2A5";
	TURNSTILE_ALLOWED_HOSTNAMES: "twistedcustomleather.com,www.twistedcustomleather.com";
	ORDER_ASSET_TOKEN_SECRET: string;
	ORDER_INTENT_TOKEN_SECRET: string;
	ORDER_MAINTENANCE_SECRET: string;
	ORDER_REFERENCE_SECRET: string;
	SQUARE_PRODUCTION_ACCESS_TOKEN: string;
	TURNSTILE_SECRET_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* twisted */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SQUARE_ENVIRONMENT" | "SQUARE_PRODUCTION_LOCATION_ID" | "TURNSTILE_ALLOWED_HOSTNAMES" | "ORDER_ASSET_TOKEN_SECRET" | "ORDER_INTENT_TOKEN_SECRET" | "ORDER_MAINTENANCE_SECRET" | "ORDER_REFERENCE_SECRET" | "SQUARE_PRODUCTION_ACCESS_TOKEN" | "TURNSTILE_SECRET_KEY">> {}
}
